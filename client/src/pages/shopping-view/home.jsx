...
import addidas from "../../assets/brand/addidas.png";
import hnm from "../../assets/brand/hm.png";
import levi from "../../assets/brand/levi's.png";
...
import footwear from "../../assets/category/footwear.png";
...
const brandsWithIcon = [
  ...
  { id: "adidas", label: "Adidas", icon: addidas },
        ...
        {featureImageList && featureImageList.length > 0
          ? featureImageList.map((slide, index) => (
              <img
                ...
                } absolute top-0 left-0 w-full h-full object-cover transition-opacity duration-50`}
              />
            ))
          : null}
        <Button
            ...
            {categoriesWithIcon.map((categoryItem) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center p-6">
                  <img src={categoryItem.icon}alt={categoryItem.label} className="h-12 object-contain mb-4"
/>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {brandsWithIcon.map((brandItem) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center p-6">
                  <img src={brandItem.icon}alt={brandItem.label} className="h-12 object-contain mb-4"
/>
